    ...
    <div class="create-an-account">
      <div class="create-an-account1">
        <div class="frame-parent">
            ...
            <div class="create-an-account-parent">
              ...
              <div class="have-an-account-login">
                <div class="already-have-an-container" id="alreadyHaveAn">
                  ...
                  <RouterLink class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" to="/Login"> Sign in</RouterLink>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="password-and-instructions">
              <div class="name">
                <div class="text-field">
                  ...
                  <div class="input-group mb-3 text-field1">
                    <input :type="inputType" class="form-control" v-model="inputValue">
                  </div>
                </div>
                <div class="text-field">
                  <div class="label-parent">
                  ...
                  <div class="input-group mb-3 text-field1">
                    <input :type="inputType" class="form-control" v-model="confirmPassword" :class="confirmPasswordClass"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" @click="toggleHide">
          ...
          <button type="button" class="btn btn-dark btn-lg" @click="register">Create an account</button>
        </div>
      </div>
      <RouterLink to="/">
        <div class="button1">
...
export default {
  ...
  computed: {
    ...
    confirmPasswordClass() {
      ...
      return this.confirmPassword === this.inputValue ? "valid-input" : "invalid-input";
    },
  },
  methods: {
    toggleHide() {
    ...
    register() {
      if (this.isPasswordValid && this.confirmPassword === this.inputValue) {
        ...
        alert('Please ensure the password is valid and matches the confirm password.');
      }
    },
  },
};
